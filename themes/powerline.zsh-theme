...
PROMPT="$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT $POWERLINE_USER_NAME %k%f$POWERLINE_SEC1_FG%K{33}"$'\ue0b0'"%k%f%F{233}%K{33} "$POWERLINE_CURRENT_PATH"%F{33} "$POWERLINE_GIT_INFO_LEFT" %k"$'\ue0b0'"%f "
